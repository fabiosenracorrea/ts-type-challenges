...
type cases = [
  ...
  // Modified because i support numbers!
  ...
  // ADDED: Handle loose comma on array
  Expect<Equal<
    Parse<'["Hello", true, false, null,]'>,
    never
  >>,

  // ADDED: Handle loose comma on object
  Expect<Equal<Parse<'{ "hello": "valid" }'>, { hello: 'valid' }>>,
  Expect<Equal<Parse<'{ "hello": "invalid", }'>, never>>,
  ...
  Expect<Equal<Parse<'{ "world": 0901 }'>, never>>,
